...
$IdentityModule = 'partgraph.knowledge.identity_catalog_worker_v4_2'
...
function Start-IdentityCollector([switch]$Refresh, [switch]$Rebuild) {
    ...
    Write-Host 'Identity reconciliation: V4.2 exact-year marketed-selection cleanup; no cross-year hybrid alias carry-forward.'

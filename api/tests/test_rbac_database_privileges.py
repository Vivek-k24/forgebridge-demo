...
class DatabasePrivilegeBoundaryTests(unittest.TestCase):
    ...
    def test_app_can_read_shared_vehicle_knowledge(self) -> None:
        ...
        self._allowed(APP_ROLE, "SELECT id FROM public.specification_definitions LIMIT 1")
        self._allowed(
            APP_ROLE,
    ...
    def test_reviewer_cannot_mutate_coverage_or_canonical_truth(self) -> None:
        ...
        self._denied(
            REVIEWER_ROLE,
            "UPDATE public.specification_definitions SET display_name = display_name WHERE false",
        )
        self._denied(
            REVIEWER_ROLE,

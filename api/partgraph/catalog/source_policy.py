...
def assess_mechanical_claim(
    *,
    ...
    This policy intentionally evaluates source authority separately from parser
    confidence. Licensing/terms are a separate source-instance gate and must be
    satisfied before automated ingestion is allowed.
    """

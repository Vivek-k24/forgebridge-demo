"""Allow the audited operator action that stages reviewed reference-parts data."""

from collections.abc import Sequence

from alembic import op

revision: str = "0056_reference_parts_audit"
down_revision: str | None = "0055_part_catalog"
...
_ACTIONS = _PREVIOUS_ACTIONS + ("reference_parts_dataset_staged",)
